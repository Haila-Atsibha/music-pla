...
async function authenticateUser(req) {
  try {
    ...
    if (!authHeader || !authHeader.startsWith('Bearer ')) {
      console.log('❌ Auth Debug - Invalid or missing Bearer token')
      return null
    }
    ...
    if (!user) {
      console.log('❌ Auth Debug - No user returned from Supabase')
      return null
    }

    console.log('✅ Auth Debug - Supabase user found:', user.id)

    // Get additional user data from our database
    console.log('🔍 Auth Debug - Looking up user in database with auth_uid:', user.id)
    ...
    console.log('✅ Auth Debug - Database user found:', dbUser.id)
